...
export default async function AdminCharacterEquipmentsPage({ params, searchParams }) {
  ...
  return (
    <AdminPageFrame
      ...
      description={
        profile
          ? 'Weapons, armor, and equipable templates are isolated here so equipment edits stop getting mixed with general inventory.'
      ...
      title={profile ? `${profile.char_name} equipments` : 'Character not found'}
    >
      {!profile ? (
