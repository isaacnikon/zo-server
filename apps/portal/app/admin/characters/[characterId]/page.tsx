...
export default async function AdminCharacterOverviewPage({ params, searchParams }) {
  ...
  return (
    <AdminPageFrame
      ...
      description={
        profile
          ? 'Overview first, then move into dedicated inventory or skill pages from the left navigation.'
      ...
      title={profile ? profile.char_name : 'Character not found'}
    >
      {!profile ? (
