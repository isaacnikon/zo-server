...
export function resolveRedirectPath(value: FormDataEntryValue | string | null | undefined, fallbackPath: string) {
...
export function buildRedirectUrl(request: Request, path: string, params: RedirectParams = {}) {
